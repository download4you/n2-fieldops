...
*See also fieldops-ctf-web/auth-infra.md — Hash Length Extension Attack (ASIS CTF 2017) (see the named bundled specialist skill) for the same primitive applied to a web auth token bypass.*

...
*See also fieldops-ctf-crypto/modern-ciphers-2.md — Hash Length Extension Attack (PlaidCTF 2014) (see the named bundled specialist skill) for the canonical crypto writeup of the same primitive.*
